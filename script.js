...
//Aa event listener to the button
button.addEventListener("click",()=>{
    //Get the input text value and trim any whitespace
...
//Remove any non-alphannumeric characters and convert to lowercase
...
//create a massage based on whether the input is a palindrome or not
